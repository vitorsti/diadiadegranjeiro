...
public class RewardedAdsButton : MonoBehaviour, IUnityAdsListener
{
    ...
    public enum Rewards { gold, cash, stamina, goldAndCash }
    ...
    public void OnUnityAdsDidFinish(string surfacingId, ShowResult showResult)
    {
        ...
        if (showResult == ShowResult.Finished)
        {
            ...
            switch (rewards)
            {
                ...
                case Rewards.goldAndCash: { MoneyManager.AddMoney("gold", goldAmount); MoneyManager.AddMoney("cash", cashAmount); break; }
